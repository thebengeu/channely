...
PORT=10001 MONGO_URL=mongodb://127.0.0.1:27017/meteor ROOT_URL=http://upthetreehouse.com forever start -a -l meteor_forever.log -o meteor_out.log -e meteor_err.log --sourceDir /ebs/channely/bundle main.js
forever stop app.js
